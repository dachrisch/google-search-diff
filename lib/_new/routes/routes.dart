...
import 'package:google_search_diff/_new/page/comparison_test.dart';
import 'package:google_search_diff/_new/page/queries_page.dart';
import 'package:google_search_diff/_new/page/query_runs.dart';
import 'package:google_search_diff/_new/page/query_runs_test.dart';
  ...
  static build() => GoRouter(
        ...
        routes: [
          ...
          GoRoute(
              ...
              builder: (context, state) => ComparisonPageTest()),
          GoRoute(
              path: '/tests/run/comparison',
              builder: (context, state) => RunComparisonPageTest()),
          GoRoute(
